...
**React todo** A simple TODO app built with `React JS`, user can add new todos and remove or mark complete existing ones.
...
```bash
git clone https://github.com/BahirHakimy/React-todo.git
```
...
- this command will start the development server on `http://127.0.0.1:5173` address
